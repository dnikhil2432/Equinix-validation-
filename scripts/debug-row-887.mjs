/**
 * Debug row 887 validation - trace through the logic
 */
import XLSX from 'xlsx'
import { runValidation, validateILIAgainstQLIs, indexQuotesBySerialNumber } from '../src/validationLogic.js'
...
console.log('Row 887 ILI serial:', serial)
...
console.log('\n--- Full runValidation for row 887 ---')
